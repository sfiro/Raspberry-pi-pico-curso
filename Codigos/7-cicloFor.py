...
for i in range(5,10):   # se configura el segundo for desde 5 hasta 10
    verde.on()
    time.sleep(1)
    verde.off()
    time.sleep(1)
...
for i in range(10,20,2):    # se configura el tercer for desde 10 hasta 20 en pasos de 2 en 2
    azul.on()
    time.sleep(1)
    azul.off()
    time.sleep(1)
